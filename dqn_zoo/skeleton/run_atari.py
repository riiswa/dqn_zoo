...
from dqn_zoo.skeleton import agent
...
def main(argv):
  ...
  del argv
  logging.info('SkeletonDQN on Atari on %s.', jax.lib.xla_bridge.get_backend().platform)
  ...
  network_fn = networks.skeleton_atari_network(num_actions)
